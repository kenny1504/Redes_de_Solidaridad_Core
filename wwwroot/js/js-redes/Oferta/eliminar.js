...
function eliminar_oferta(button) {
	...
	ide = $(button).attr("data-id"); // captura el valor_id_oferta "id" de la oferta
	$('#eliminar_Oferta').modal('show'); // abre ventana modal
}
...
$("#confirmar_eliminar_oferta").click(function () {
	...
	$.ajax({
		type: 'POST',
		url: 'Oferta/EliminarOferta', // ruta eliminar oferta
		data: { id: ide}, // manda el form donde se encuentra la modal oferta
		dataType: "JSON",
