...
function Registro_Institucion() { //ajax para Registrar una Institucion

    var tabla = $.trim($("#Usuarios").html());
    //este codigo cancela el evento submit en el form donde que esta la modal 
    $("#ingresar_Instituciones").on('submit', function (evt) {
        evt.preventDefault();
    });
